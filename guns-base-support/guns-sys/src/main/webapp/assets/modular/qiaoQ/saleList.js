layui.use(['table', 'ax', 'treetable'], function () {
    ...
    Sale.search = function () {
        ...
        Sale.initTable(Sale.tableId, queryData);
    };

    /**
     * 弹出添加对话框
     */
    Sale.openAddDlg = function () {
     ...
     */
    Sale.openEditDlg = function (data) {
     ...
     * 渲染表格
     */
    Sale.initTable = function (dictId, data) {
