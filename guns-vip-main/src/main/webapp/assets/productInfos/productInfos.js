layui.use(['table', 'admin', 'ax'], function () {
    ...
    ProductInfos.initColumn = function () {
        return [[{type: 'checkbox'},
            ...
            {field: 'productPrice', sort: true, title: '商品出售价'},
            {field: 'marketPrice', sort: true, title: '市场价'},
            {field: 'pleasedPrice', sort: true, title: '进货价'},
            {field: 'customerPleasedPrice', sort: true, title: '客户进货价'},
    ...
    //     var operation = function () {
    //         var ajax = new $ax(Feng.ctxPath + "/productInfos/buyPage", function (data) {
    //             Feng.success("下单成功!");
    //             table.reload(ProductInfos.tableId);
    //         }, function (data) {
    ...
    var tableResult = table.render({
        ...
        url: Feng.ctxPath + '/productInfos/list',
        page: true,
        height: "full-158",
        cellMinWidth: 100,
